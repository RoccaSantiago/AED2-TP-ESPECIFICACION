	...
	\subsection{hayBallotage}
		\subsubsection{Main}
			...
			\begin{proc}{hayBallotage}{\In escrutinio : \TLista{\ent}}{\bool}
				...
				\requiere{noHayRepetidos(escrutinio) \land_{ L }\:  cantVotosValidos(escrutinio) \: \land_{ L }\: eleccionValida(escrutinio)}
...
\subsection{hayFraude}
		\subsubsection{Main}
			...
			%UMBAL ELECTORAL NO SABEMOS BIEN
				\requiere{umbralElectoral(escrutinio\_senadores)\: \land_{ L } \:votosValidos/NoRepetidos(escrutinio\_Presidencial) \: \land_{ L } \:\\ votosValidos/NoRepetidos(escrutinio\_senadores) \: \land_{ L } \: votosValidos/				NoRepetidos(escrutinio\_diputados) \: \land_{ L }\: \\ eleccionValida(escrutinio)}
		...
		\subsubsection{Predicados Especificos}
			...
			\pred{votosValidos/NoRepetidos}{\In escrutinio : \TLista{\ent}}{noHayRepetidos(escrutinio)\land_{L} cantVotosVallidos(escrutinio)}
	...
	\subsection{validarListasDiputadosEnProvincia}
		\subsubsection{Main}
			...
			\begin{proc}{(\In cant bancas: \ent, \In listas: \TLista{\TLista{dni:\ent \times genero: \ent}}}{\bool}
			
				\requiere{}
				\asegura{(\forall \: partido:\ent)(0\leq x<|listas|) \longrightarrow_{L} (cantCandidatosCorrecta(cant\_bancas,\: listas[partido])\land_{L} altGenero(listas[partido])}			
	...
	\subsection{Auxiliares}
		...
		\aux{porcentajeDeVotos}{escrutinio: \TLista{\ent}, partido: \TLista{\ent}}{\float}{sumaDeVotos(escrutinio)^{-1} *escrutinio[partido]*10^{2})}
	
	\subsection{Predicados Universales}
		
		\pred{noHayRepetidos}{\In escrutinio : \TLista{\ent}}{((((\forall x: \ent)(0 \leq x < |escrutinio|) \: \land_{ L } \: ((\forall y: \ent)(0 \leq y < |escrutinio|)) \: \land_{ L }  \: \neg(x=y)) \: \longrightarrow_{L }\neg(escrutinio[x] = escrutinio[y]))}
		
		\pred{cantVotosValidos}{\In escrutinio : \TLista{\ent}}{((\forall x: \ent)(0 \leq x < |escrutinio|) \: \longrightarrow_{L } (escrutinio[x] \geq 0))}
	
		\pred{eleccionValida}{\In escrutinio: \TLista{\ent}}{|escrutinio| \geq 2}
