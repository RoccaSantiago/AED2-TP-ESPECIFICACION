	...
	\subsection{hayBallotage}
		...
		\subsubsection{Main}
			...
			\begin{proc}{hayBallotage}{\In escrutinio : \TLista{\ent}}{\bool}
				...
				\requiere{noHayRepetidos(escrutinio) \land_{ L }\:  (\forall x: \ent)(0 \leq x < |escrutinio|) \: \longrightarrow_{L } escrutinio[x] \geq 0))}
	...
	\subsection{hayFraude}
		...
		\subsubsection{Main}
			...
			\begin{proc}{hayFraude}{(\In escrutinio\_Presidencial: \TLista{\ent}, in escrutinio\_senadores: \TLista{\ent}⟩, in escrutinio\_diputados: \TLista{\ent}}{\bool}
				...
				\requiere{True}
				\asegura{res=\neg(((|sumaDeVotos(escrutinio\_Presidencia) = sumaDeVotos(escrutinio\_Senadores)) \land_{L} \\ (sumaDeVotos(escrutinio\_Presidencial) = sumaDeVotos(escrutinio\_Diputados)))}
