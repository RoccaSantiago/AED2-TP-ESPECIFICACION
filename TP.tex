...
\subsection{hayFraude}
		\subsubsection{Main}
			...
			%UMBAL ELECTORAL NO SABEMOS BIEN
				\requiere{umbralElectoral(escrutinio\_senadores)\: \land\:eleccionValida(escrutinio\_Presidencial) \: \land\:\\ eleccionValida(escrutinio\_senadores) \: \land \: eleccionValida(escrutinio\_diputados) \land minimoDePartidos(escrutinio\_Senadores)}
				
				\asegura{res=\neg(((|sumaDeVotos(escrutinio\_Presidencial) = sumaDeVotos(escrutinio\_Senadores)) \land \\ (sumaDeVotos(escrutinio\_Presidencial) = sumaDeVotos(escrutinio\_Diputados)))}
